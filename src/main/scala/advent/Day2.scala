...
object Day2 extends App {
  ...
  val resultPart1 = Day2Solution.run(12, 2)
  println(s"Part 1: program after execution: ${resultPart1}")           // 9581917

  val resultPart2 = Day2Solution.inputFor(19690720)
  println(s"Part 2: input noun and verb for 19690720: $resultPart2")    // (25, 5)
...
//    println(s"operation ${operation} at position ${pointer}, program ${program}")
...
//    println(s" running for $noun, $verb")
